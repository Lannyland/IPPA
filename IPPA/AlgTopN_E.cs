...
namespace IPPA
{
    class AlgTopN_E : AlgPathPlanning
    {
        #region Members
        ...
        // Constructor
        public AlgTopN_E(PathPlanningRequest _curRequest, int _ModeCount, RtwMatrix _mModes, RtwMatrix _mDistReachable,
        ...
        {
            Console.WriteLine("I am AlgTopN_E!");
        }
